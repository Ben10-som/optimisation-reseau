...
- **Kédougou :** Région montagneuse, densité de population faible, accès limité aux infrastructures.
- **Tambacounda :** Grande région avec des zones rurales étendues, accès limité à Internet.
- **Matam :** Région frontalière avec des défis d'accès aux services de télécommunication, population majoritairement rurale.
...
knitr::include_graphics("images/carte senegal.png")
```
