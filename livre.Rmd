...
packages <- c("labelled", "haven","dplyr","flextable","officer","officedown","janitor","outliers","naniar","lubridate","ggplot2","gtsummary")
...
```{r page_garde_5}
donnees <- data.frame(
  col1 = c("Rédigé par", "SOMA Ben Idriss ","yves Djarakei"),
  col2 = c("Sous la supervision de", "M. Omar DIOP ", "Docteur en Mathématiques "),
...
```{r operator-coverage, echo=FALSE, fig.cap="Comparaison de la couverture réseau par opérateur", message=FALSE, fig.width=5, fig.height=4.5, fig.align='center'}
library(ggplot2)
library(tidyr)
...
ggsave("operator_coverage.png", width = 8, height = 5, dpi = 300)
```
...
```{r frequency-spectrum, echo=FALSE, fig.cap="Spectre de fréquence d'un signal composé", message=FALSE, fig.width=5, fig.height=4.5, fig.align='center'}
library(ggplot2)
...
```{r modulation, echo=FALSE, fig.cap="Modulation d'amplitude : modulant, porteuse et signal modulé", message=FALSE, fig.width=5, fig.height=4.5, fig.align='center'}
library(ggplot2)
library(tidyr)
library(viridis)
library(dplyr)
