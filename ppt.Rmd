...
knitr::opts_chunk$set(echo = FALSE, 
                      ...
                      comment = NA,
                      fig.width = 8,
                      fig.height = 4.5)  # Ajusté pour PowerPoint
library(ggplot2)
library(tidyr)
library(knitr)
```
...
| Données démographiques et géographiques | Carte du Sénégal |
|----------------------------------------|------------------|
| - Population : 18 593 258 (2024)       | ![Carte du Sénégal](images/carte sen.png) |
| - Superficie : 196 722 km²             |                  |
| - Taux d'urbanisation : ~54,7% (ANSD)  |                  |
