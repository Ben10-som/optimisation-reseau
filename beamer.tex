...
\titlegraphic{\includegraphics[width=0.25\textwidth]{images/ensae.png}}
\ifLuaTeX
...
\item
  Proposer un modèle de simulation pour le placement optimal des
  antennes
\end{itemize}
\end{frame}

\begin{frame}{Méthodologie}
\phantomsection\label{muxe9thodologie}
\textbf{Étapes clés :}
...
\begin{frame}{Présentation du Sénégal et de la zone d'étude}
\phantomsection\label{pruxe9sentation-du-suxe9nuxe9gal-et-de-la-zone-duxe9tude}
\begin{columns}
  ...
  \begin{itemize}
    \item Population : 18 593 258 d'habitants en 2024
    \item Superficie : 196 722 km²
    \item Taux d'urbanisation : ~54,7\% d'après l'ANSD
    \item Accès à Internet : ~58\% (2022)
  \end{itemize}
  
  \textbf{Répartition administrative :}
  
  \begin{itemize}
    \item 14 régions administratives
    \item Concentration des infrastructures dans l'ouest
    \item Zones rurales sous-connectées
  \end{itemize}
  
  \column{0.5\textwidth}
  
  \begin{center}
    \includegraphics[width=0.9\textwidth]{images/carte sen.png}
  \end{center}
...
\phantomsection\label{zone-duxe9tude}
...
\textbf{Caractéristiques géographiques :} - \textbf{Kédougou :} Région
montagneuse, densité de population faible, accès limité aux
infrastructures. - \textbf{Tambacounda :} Grande région avec des zones
rurales étendues, accès limité à Internet. - \textbf{Matam :} Région
frontalière avec des défis d'accès aux services de télécommunication,
...
\item ~
  \subsection{Disparités importantes
  urbain/rural}\label{disparituxe9s-importantes-urbainrural}
\end{itemize}

\begin{center}\includegraphics[width=1\linewidth]{images/carte senegal} \end{center}
...
\begin{frame}{Vue d'ensemble du Sénégal de la couverture reseau}
\phantomsection\label{vue-densemble-du-suxe9nuxe9gal-de-la-couverture-reseau}
\end{frame}

\begin{frame}{Carte de la couverture réseau}
\phantomsection\label{carte-de-la-couverture-ruxe9seau}
\begin{center}\includegraphics[width=1\linewidth]{images/carte_couverture_2G} \end{center}
\end{frame}

\begin{frame}{\#nouvelle page}
\phantomsection\label{nouvelle-page}
\begin{center}\includegraphics[width=1\linewidth]{images/carte_couverture_3G} \end{center}
\end{frame}

\begin{frame}
\begin{center}\includegraphics[width=1\linewidth]{images/carte_couverture_4G} \end{center}
\end{frame}
...
\caption{Comparaison de la couverture par opérateur}
\end{figure}
\end{frame}
...
\caption{Spectre de fréquence d'un signal}
\end{figure}
\end{frame}
...
\caption{Modulation d'un signal}
\end{figure}
\end{frame}
...
\caption{Propagation des ondes en espace libre}
\end{figure}
\end{frame}
